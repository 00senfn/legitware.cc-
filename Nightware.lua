...
game.StarterGui:SetCore(
	...
	{
		Title = "Nightware.cc",
		Text = "Credits to Nightware.cc for HC support!",
	}
)
wait(3)
 ...
 local NotifyLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kinlei/Dynissimo/main/Scripts/AkaliNotif.lua"))()
    ...
    local Window = Library:CreateWindow("Nightware.cc", Vector2.new(492, 598), Enum.KeyCode.V)
